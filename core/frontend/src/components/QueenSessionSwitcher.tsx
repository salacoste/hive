...
interface QueenSessionSwitcherProps {
  ...
  onCreateNew: () => void;
  onOpenData?: (sessionId: string) => void;
}
              ...
              return (
                ...
                >
                  <button
                    ...
                    className={`w-full text-left px-3 pt-2.5 pb-2 text-xs transition-colors ${
                      isActive
                        ? "text-foreground"
                    ...
                    <div className="px-3 pb-2">
                      <button
                        onClick={(event) => {
                          ...
                          setOpen(false);
                          onOpenData(session.session_id);
                        }}
                        className="inline-flex items-center gap-1.5 rounded-md border border-border/50 px-2 py-1 text-[10px] font-medium text-muted-foreground hover:text-foreground hover:bg-muted/30 transition-colors"
                        title="Open data for this session"
                      >
